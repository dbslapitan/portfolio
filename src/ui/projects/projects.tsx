    ...
    return (
        <section id='projects' className={`${style['projects']}`} ref={elementRef}>
            ...
            <section className={`${style['project']}`}>
                ...
                <div className={`${style['project__right']}`}>
                    <p className={`${style['project__description']}`}>BrainStation bootcamp industry project with Shopify: Collaborated with UX/UI designers, data scientists, and cybersecurity cohorts to develop a menu-based chatbot that supports merchants in streamlining product return processes, enhancing customer satisfaction.</p>
                    <div className={`${style['project__stack']}`}>
                        {
                            nomiStack.map(tech => {
                                return (
